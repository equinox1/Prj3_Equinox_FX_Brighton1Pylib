...
class CMdtunerHyperModel:
   def __init__(self, **kwargs):
         ...
         self.tf2 = kwargs.get('tf2T', False)
...
class CMqlEnvTuneML:
    def __init__(self, **kwargs):
         ...
         # data split
         mp_ml_train_split = kwargs.get('mp_ml_train_split', 0.7)
         mp_ml_validation_split = kwargs.get('mp_ml_validation_split', 0.2)
         mp_ml_test_split = kwargs.get('mp_ml_test_split', 0.1)
         
         self.train_split = kwargs.get('train_split',mp_ml_train_split)
         self.validation_split = kwargs.get('validation_split',mp_ml_validation_split)
         self.test_split = kwargs.get('test_split',mp_ml_test_split)
         ...
         self.baseuniq = kwargs.get('baseuniq', mp_ml_baseuniq)
         self.project_name = kwargs.get('project_name', mp_ml_project_name)
         self.subdir = os.path.join(self.base_path, 'tshybrid_ensemble_tuning_prod', str(1))
         self.modeldatapath = kwargs.get('modeldatapath', mp_ml_num_base_path)
         self.directory = kwargs.get('directory',mp_ml_directory)
         self.base_checkpoint_filepath = kwargs.get('base_checkpoint_filepath', mp_ml_num_base_path)
