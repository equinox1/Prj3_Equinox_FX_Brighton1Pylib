...
class CDMLProcess:
    ...
    def _set_global_parameters(self, kwargs):
        ...
        logger.info("mp_ml_cfg_period: %d, mp_ml_cfg_period1: %d, mp_ml_cfg_period2: %d, mp_ml_cfg_period3: %d, mp_ml_tf_ma_windowin: %d",
                    self.mp_ml_cfg_period, self.mp_ml_cfg_period1, self.mp_ml_cfg_period2, self.mp_ml_cfg_period3, self.mp_ml_tf_ma_windowin)
        logger.info("pasttimeperiods: %d, futuretimeperiods: %d, predtimeperiods: %d", self.pasttimeperiods, self.futuretimeperiods, self.predtimeperiods)
    ...
    def create_ml_window(self, timeval):
        ...
        logger.info("past_width: %d, future_width: %d, pred_width: %d, timeval: %d", 
                    past_width, future_width, pred_width, timeval)
        logger.info("features_count: %d, labels_count: %d, batch_size: %d", 
                    features_count, labels_count, batch_size)
